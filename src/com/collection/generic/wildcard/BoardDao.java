...
import com.collection.list.board.Board;
...
public class BoardDao {
    ...
    public List<com.collection.list.board.Board> getBoardList() {
    ...
    public void getBoardSize(List<com.collection.list.board.Board> boardList) {
        System.out.println("현재 총 게시글의 수는 " + boardList.size() + "입니다.");
    }

    public void getBoardAll(List<com.collection.list.board.Board> boardList) {
        System.out.println("\n-------------------게시글 모두 보기----------------------");
        for (com.collection.list.board.Board board : boardList) {
    ...
    public void boardInsert(String subject, String writer, String content) {
        System.out.println("\n-------------------게시글 추가----------------------");
        com.collection.list.board.Board board = new Board(subject, writer, content);
